    ...
    <div class="col-md-12">
        <div class="panel panel-white">
            <div class="panel-heading clearfix">
                <h4 class="panel-title">Career</h4>
            </div>
                ...
                <div class="table-responsive">
                    <table class="table" id="role_table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td><img src="../../public/uploads/career/{{$details->image}}" class="img-thumbnail" width="300" /></td>
                                <td>{{$details->heading}}</td>
                                <td>{{$details->description}}</td>
                                <td>
                                <a href="{{url('admin/career/edit/'.$details->id)}}" class="btn btn-info">Edit</a>
