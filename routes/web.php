...
Route::get('/db-backup','DbController@dbBackup');
...
Route::prefix('admin')->middleware(['Logged'])->middleware(['role_admin'])->group(function(){
	...
	//Earnings
	Route::get('earnings','Admin\EarningController@index');
	Route::get('earnings/update-earning','Admin\EarningController@updateearning');
	Route::post('earnings/store','Admin\EarningController@store');

	Route::get('earnings/aum','Admin\EarningController@aum');
	Route::get('earnings/details/{username}','Admin\EarningController@details');
	Route::get('earnings/edit/{id}','Admin\EarningController@edit');
	Route::post('earnings/update','Admin\EarningController@update');

	//Activation
	Route::get('activate','Admin\ActivateController@index');
	Route::get('activate/add-user/{parent_id}','Admin\ActivateController@addUser');
	Route::post('activate/store','Admin\ActivateController@store');
	//Route::get('activate/create','Admin\ActivateController@create');
	Route::get('activate/edit-user/{id}','Admin\ActivateController@edit');
	Route::post('activate/update-user','Admin\ActivateController@updateuser');
	Route::get('activate/delete-user/{id}','Admin\ActivateController@deleteUser');
	Route::get('activate/image/{id}','Admin\ActivateController@userImage');
	Route::post('activate/update-image','Admin\ActivateController@updateImage');
	//Route::post('activate/store','Admin\ActivateController@store');
	//Route::post('activate/update/{id}','Admin\ActivateController@update');
	//Route::get('activate/delete/{id}','Admin\ActivateController@delete');
	//Route::get('user/create','Admin\UsersController@create');
	//Route::get('user/edit/{id}','Admin\UsersController@edit');
	//Route::post('user/store','Admin\UsersController@store');
	//Route::post('user/update/{id}','Admin\UsersController@update');
