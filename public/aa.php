<html>
   ...
   <body>
    ...
    <div style=\"text-align: left;display: block;padding:2px 8px;\">
        <div>
			To complete  click on <a style=\"background-color: #ADD8E6; border: none; color: white; padding: 10px 20px; text-align: center; text-decoration: none; display: inline-block; font-size: 16px; \" href=\"https://www.google.com/\">Activation Link</a>.</div>
        <div>If the above link does not work correctly, go to last by</div>
</div>
